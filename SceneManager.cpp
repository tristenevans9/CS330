...
void SceneManager::LoadSceneTextures() {
	...
	bReturn = CreateGLTexture("U:/CS330Content/Projects/7-1_FinalProjectMilestones/textures/computer.jpeg", "computer");
	bReturn = CreateGLTexture("U:/CS330Content/Projects/7-1_FinalProjectMilestones/textures/wall.jpeg", "wall");
	bReturn = CreateGLTexture("U:/CS330Content/Projects/7-1_FinalProjectMilestones/textures/desk.jpeg", "desk");
	bReturn = CreateGLTexture("U:/CS330Content/Projects/7-1_FinalProjectMilestones/textures/keyboard.jpeg", "keyboard");
	bReturn = CreateGLTexture("U:/CS330Content/Projects/7-1_FinalProjectMilestones/textures/candle.jpeg", "candle");
	bReturn = CreateGLTexture("U:/CS330Content/Projects/7-1_FinalProjectMilestones/textures/stained glass.jpeg", "stained glass");
	bReturn = CreateGLTexture("U:/CS330Content/Projects/7-1_FinalProjectMilestones/textures/book.jpeg", "book");
	bReturn = CreateGLTexture("U:/CS330Content/Projects/7-1_FinalProjectMilestones/textures/leather book.jpg", "leather book");
	bReturn = CreateGLTexture("U:/CS330Content/Projects/7-1_FinalProjectMilestones/textures/gold book.jpg", "gold book");
	bReturn = CreateGLTexture("U:/CS330Content/Projects/7-1_FinalProjectMilestones/textures/book3.png", "book3");

	// after the texture image data is loaded into memory, the
	// loaded textures need to be boud to texture slots - there
...
* SetUpSceneLights
*
* This method is used to add lighting into the scene to use
* rather than the default lighting
************************************************************/
void SceneManager::SetUpSceneLights() {
	...
	// point light 3
	m_pShaderManager->setVec3Value("pointLights[2].position", 4.0f, 5.0f, -0.75f);
	...
	m_pShaderManager->setVec3Value("pointLights[2].specular", 1.5f, 1.5f, 1.5f);
...
* DefineObjectMaterials()
* 
* This method is used to define and load the material types
...
void SceneManager::RenderScene()
{
	...
	scaleXYZ = glm::vec3(25.0f, 1.0f, 7.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 10.0f, -7.5f);
	...
	// Code for the bottom of computer stand
	/****************************************************************/
	/*** Set needed transformations before drawing the basic mesh.  ***/
	/*** This same ordering of code should be used for transforming ***/
	/*** and drawing all the basic 3D shapes.						***/
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.5f, 0.20f, 3.5f);
	...
	// Code for the vertical portion of computer stand
	/****************************************************************/
	/*** Set needed transformations before drawing the basic mesh.  ***/
	/*** This same ordering of code should be used for transforming ***/
	/*** and drawing all the basic 3D shapes.						***/
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.5f, 0.25f, 2.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.0f, 1.25f, -2.0f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(10.0f, 5.0f,0.25f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.0f, 3.75f, -1.0f);
	...
	// Code for screen of computer
	/*** Set needed transformations before drawing the basic mesh.  ***/
	/*** This same ordering of code should be used for transforming ***/
	/*** and drawing all the basic 3D shapes.						***/
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.25f, 1.0f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.0f, 3.75f, -0.80f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, 4.25f, 3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 2.15f, -1.0f);
	...
	// Code for the left standing book
	/****************************************************************/
	/*** Set needed transformations before drawing the basic mesh.  ***/
	/*** This same ordering of code should be used for transforming ***/
	/*** and drawing all the basic 3D shapes.						***/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.55f, 2.15f, -1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 0.25f, -1.0f);
	...
	SetShaderTexture("gold book");
	// draw the box
	m_basicMeshes->DrawBoxMesh();

	// Code for the middle book
	/****************************************************************/
	/*** Set needed transformations before drawing the basic mesh.  ***/
	/*** This same ordering of code should be used for transforming ***/
	/*** and drawing all the basic 3D shapes.						***/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 0.78f, -1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 1.32f, -1.0f);
	...
	SetShaderTexture("leather book");
	// draw the box
	m_basicMeshes->DrawBoxMesh();

	// Code for the glass ball
	/****************************************************************/
	/*** Set needed transformations before drawing the basic mesh.  ***/
	/*** This same ordering of code should be used for transforming ***/
	/*** and drawing all the basic 3D shapes.						***/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.0f, 1.0f, 1.75f);
	...
	SetShaderTexture("stained glass");
	// draw the box
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.75f, 2.25f, 0.75f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(7.25f, 0.25f, 1.35f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.25f, 5.25f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.0f, 0.25f, 3.0f);
